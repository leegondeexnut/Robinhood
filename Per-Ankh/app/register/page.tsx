      ...
      <section className="p-5">
        ...
        <form className="pb-7" onSubmit={handleSubmit}>
          ...
          <div className="mt-16 mx-10 grid grid-col">
            ...
            <select
              className="bg-black border-2 border-gray-600 p-2 rounded h-12 w-78"
              name="role"
              value={form.role}
              onChange={handlechange}
            >
          ...
          <div className="grid grid-col mt-7 mx-10">
            ...
            <textarea
              ...
              className="border-2 border-gray-600 p-2 rounded min-h-78 w-78"
              value={form.bio}
              onChange={handlechange}
            />
          </div>
          <button
            type="submit"
            className="bg-[#40E0D0] rounded p-3 m-2 ml-22 text-xl hover:bg-red-300"
          >
            Sign Up
          </button>
        </form>
